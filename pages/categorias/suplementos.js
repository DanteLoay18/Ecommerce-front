...
export default function SuplementosPage({categorias,allProducts}) {
    ...
    return (
        <div>
          <LazyHeaderPrincipal categories={categorias} />
                  ...
                  <StyledDiv>
                    <LazySubCategorias categories={categorias} name={'Suplementos'} products={allProducts}></LazySubCategorias>
                  </StyledDiv>
