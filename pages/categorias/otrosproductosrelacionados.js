...
export default function OtrosProductosRelacionadosPage({categorias,allProducts}) {
    ...
    return (
        <div>
          <LazyHeaderPrincipal categories={categorias} />
                  ...
                  <StyledDiv>
                     <LazySubCategorias categories={categorias} name={'Otros productos relacionados'} products={allProducts}></LazySubCategorias>
                  </StyledDiv>
